...
class WorldModel(genpy.Message):
  _md5sum = "580fee34fabf1d6f23f48ba7af5e653c"
...
float64 y
float64 z"""
  __slots__ = ['header','world_map','enable_resource_tracking']
  _slot_types = ['std_msgs/Header','mir_msgs/WorldMap[]','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,world_map,enable_resource_tracking
    ...
    if args or kwds:
      ...
      if self.world_map is None:
        self.world_map = []
      if self.enable_resource_tracking is None:
        self.enable_resource_tracking = False
    else:
      self.header = std_msgs.msg.Header()
      self.world_map = []
      self.enable_resource_tracking = False
    ...
    try:
      ...
      for val1 in self.world_map:
        ...
        for val3 in _v1.resources:
          ...
          length = len(val3.resource_geometry)
          buff.write(_struct_I.pack(length))
          for val4 in val3.resource_geometry:
            _x = val4
            buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        ...
        for val3 in _v9.robots:
          ...
          buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
          _x = val3
          buff.write(_get_struct_2d().pack(_x.robot_length, _x.robot_width))
          _x = val3.footprint
          length = len(_x)
          if python3 or type(_x) == unicode:
            _x = _x.encode('utf-8')
        ...
        _x = val1.map_id
        buff.write(_get_struct_i().pack(_x))
      _x = self.enable_resource_tracking
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            (_x.x, _x.y, _x.z,) = _get_struct_3d().unpack(str[start:end])
            val3.resource_geometry.append(val4)
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          val3.queue = []
        ...
        if python3:
          _v23.token = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v23.token = str[start:end]
        _v27 = val1.areas
        _v28 = _v27.header
        start = end
        end += 4
        ...
        if python3:
          _v27.token = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v27.token = str[start:end]
        _v31 = val1.robots
        _v32 = _v31.header
        start = end
        end += 4
        ...
        for i in range(0, length):
          ...
          (_x.robot_length, _x.robot_width,) = _get_struct_2d().unpack(str[start:end])
          start = end
          end += 4
          (length,) = _struct_I.unpack(str[start:end])
          start = end
      ...
      (self.enable_resource_tracking,) = _get_struct_B().unpack(str[start:end])
      self.enable_resource_tracking = bool(self.enable_resource_tracking)
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v67.token = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v67.token = str[start:end]
        _v71 = val1.areas
        _v72 = _v71.header
        start = end
        end += 4
        ...
        if python3:
          _v71.token = str[start:end].decode('utf-8', 'rosmsg')
        else:
          _v71.token = str[start:end]
        _v75 = val1.robots
        _v76 = _v75.header
        start = end
        end += 4
