...
class WorldMap(genpy.Message):
  _md5sum = "ec0a9f4a5448b3a8ef606ac88d5ab93a"
...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.positions.token = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.positions.token = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.areas.token = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.areas.token = str[start:end]
      _x = self
      start = end
      end += 12
