...
class ResourceState(genpy.Message):
  _md5sum = "57fcc2e24446160c25e1fac48251c1da"
  _type = "mir_msgs/ResourceState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string[] assigned # A list of IPs of all assigned robots (Areas can have more than one robot assigned at a time)
...
"""
  ...
  __slots__ = ['assigned','type','path_idx','distance','collision_point','resource_geometry','queue','name','guid']
  _slot_types = ['string[]','uint32','uint32','float32','geometry_msgs/Point','geometry_msgs/Point[]','string[]','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       assigned,type,path_idx,distance,collision_point,resource_geometry,queue,name,guid
    ...
    if args or kwds:
      ...
      if self.resource_geometry is None:
        self.resource_geometry = []
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.resource_geometry)
      buff.write(_struct_I.pack(length))
      for val1 in self.resource_geometry:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.resource_geometry.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.queue = []
