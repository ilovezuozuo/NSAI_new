...
class MirMoveBaseActionResult(genpy.Message):
  _md5sum = "bba42cc37afb0f3bc0d230821314e0cd"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_10d().pack(_x.result.end_pose.pose.position.x, _x.result.end_pose.pose.position.y, _x.result.end_pose.pose.position.z, _x.result.end_pose.pose.orientation.x, _x.result.end_pose.pose.orientation.y, _x.result.end_pose.pose.orientation.z, _x.result.end_pose.pose.orientation.w, _x.result.pose.x, _x.result.pose.y, _x.result.pose.theta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.end_pose.pose.position.x, _x.result.end_pose.pose.position.y, _x.result.end_pose.pose.position.z, _x.result.end_pose.pose.orientation.x, _x.result.end_pose.pose.orientation.y, _x.result.end_pose.pose.orientation.z, _x.result.end_pose.pose.orientation.w, _x.result.pose.x, _x.result.pose.y, _x.result.pose.theta,) = _get_struct_10d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
