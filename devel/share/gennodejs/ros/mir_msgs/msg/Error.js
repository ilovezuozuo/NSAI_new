...
class Error {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('nolog')) {
        this.nolog = initObj.nolog
      }
      else {
        this.nolog = false;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [nolog]
    bufferOffset = _serializer.bool(obj.nolog, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [nolog]
    data.nolog = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.nolog !== undefined) {
      resolved.nolog = msg.nolog;
    }
    else {
      resolved.nolog = false
    }
