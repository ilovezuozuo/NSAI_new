...
class RobotStatus {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.safety_system_muted = null;
      this.joystick_low_speed_mode_enabled = null;
      this.joystick_web_session_id = null;
      this.mode_key_state = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('hook_data')) {
        this.hook_data = initObj.hook_data
      }
      else {
        this.hook_data = new HookData();
      }
      ...
      if (initObj.hasOwnProperty('safety_system_muted')) {
        this.safety_system_muted = initObj.safety_system_muted
      }
      else {
        this.safety_system_muted = false;
      }
      if (initObj.hasOwnProperty('joystick_low_speed_mode_enabled')) {
        this.joystick_low_speed_mode_enabled = initObj.joystick_low_speed_mode_enabled
      }
      else {
        this.joystick_low_speed_mode_enabled = false;
      }
      if (initObj.hasOwnProperty('joystick_web_session_id')) {
        this.joystick_web_session_id = initObj.joystick_web_session_id
      }
      else {
        this.joystick_web_session_id = '';
      }
      if (initObj.hasOwnProperty('mode_key_state')) {
        this.mode_key_state = initObj.mode_key_state
      }
      else {
        this.mode_key_state = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [hook_data]
    bufferOffset = HookData.serialize(obj.hook_data, buffer, bufferOffset);
    ...
    // Serialize message field [safety_system_muted]
    bufferOffset = _serializer.bool(obj.safety_system_muted, buffer, bufferOffset);
    // Serialize message field [joystick_low_speed_mode_enabled]
    bufferOffset = _serializer.bool(obj.joystick_low_speed_mode_enabled, buffer, bufferOffset);
    // Serialize message field [joystick_web_session_id]
    bufferOffset = _serializer.string(obj.joystick_web_session_id, buffer, bufferOffset);
    // Serialize message field [mode_key_state]
    bufferOffset = _serializer.string(obj.mode_key_state, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [hook_data]
    data.hook_data = HookData.deserialize(buffer, bufferOffset);
    ...
    // Deserialize message field [safety_system_muted]
    data.safety_system_muted = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [joystick_low_speed_mode_enabled]
    data.joystick_low_speed_mode_enabled = _deserializer.bool(buffer, bufferOffset);
    // Deserialize message field [joystick_web_session_id]
    data.joystick_web_session_id = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [mode_key_state]
    data.mode_key_state = _deserializer.string(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.joystick_web_session_id);
    length += _getByteLength(object.mode_key_state);
    return length + 174;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.hook_data !== undefined) {
      resolved.hook_data = HookData.Resolve(msg.hook_data)
    }
    else {
      resolved.hook_data = new HookData()
    }
    ...
    if (msg.safety_system_muted !== undefined) {
      resolved.safety_system_muted = msg.safety_system_muted;
    }
    else {
      resolved.safety_system_muted = false
    }

    if (msg.joystick_low_speed_mode_enabled !== undefined) {
      resolved.joystick_low_speed_mode_enabled = msg.joystick_low_speed_mode_enabled;
    }
    else {
      resolved.joystick_low_speed_mode_enabled = false
    }

    if (msg.joystick_web_session_id !== undefined) {
      resolved.joystick_web_session_id = msg.joystick_web_session_id;
    }
    else {
      resolved.joystick_web_session_id = ''
    }

    if (msg.mode_key_state !== undefined) {
      resolved.mode_key_state = msg.mode_key_state;
    }
    else {
      resolved.mode_key_state = ''
    }
