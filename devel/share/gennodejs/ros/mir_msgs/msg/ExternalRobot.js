...
class ExternalRobot {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.type_id = null;
      this.name = null;
      this.robot_length = null;
      this.robot_width = null;
      this.footprint = null;
      this.ip = null;
      this.map_id = null;
      this.priority = null;
      ...
      if (initObj.hasOwnProperty('robot_length')) {
        this.robot_length = initObj.robot_length
      }
      else {
        this.robot_length = 0.0;
      }
      if (initObj.hasOwnProperty('robot_width')) {
        this.robot_width = initObj.robot_width
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [robot_length]
    bufferOffset = _serializer.float64(obj.robot_length, buffer, bufferOffset);
    // Serialize message field [robot_width]
    bufferOffset = _serializer.float64(obj.robot_width, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [robot_length]
    data.robot_length = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [robot_width]
    data.robot_width = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.robot_length !== undefined) {
      resolved.robot_length = msg.robot_length;
    }
    else {
      resolved.robot_length = 0.0
    }

    if (msg.robot_width !== undefined) {
      resolved.robot_width = msg.robot_width;
    }
    else {
      resolved.robot_width = 0.0
    }
