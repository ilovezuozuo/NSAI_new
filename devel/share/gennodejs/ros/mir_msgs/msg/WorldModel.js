...
class WorldModel {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.header = null;
      this.world_map = null;
      this.enable_resource_tracking = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('enable_resource_tracking')) {
        this.enable_resource_tracking = initObj.enable_resource_tracking
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [enable_resource_tracking]
    bufferOffset = _serializer.bool(obj.enable_resource_tracking, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [enable_resource_tracking]
    data.enable_resource_tracking = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.enable_resource_tracking !== undefined) {
      resolved.enable_resource_tracking = msg.enable_resource_tracking;
    }
    else {
      resolved.enable_resource_tracking = false
    }
