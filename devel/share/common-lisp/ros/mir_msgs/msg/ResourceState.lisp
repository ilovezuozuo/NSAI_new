...
(cl:defclass <ResourceState> (roslisp-msg-protocol:ros-message)
  ((assigned
   ...
   (resource_geometry
    :reader resource_geometry
    :initarg :resource_geometry
...
(cl:ensure-generic-function 'resource_geometry-val :lambda-list '(m))
(cl:defmethod resource_geometry-val ((m <ResourceState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:resource_geometry-val is deprecated.  Use mir_msgs-msg:resource_geometry instead.")
  (resource_geometry m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ResourceState>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'resource_geometry))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'resource_geometry))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ResourceState>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'resource_geometry) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'resource_geometry)))
    (cl:dotimes (i __ros_arr_len)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ResourceState>)))
  ...
  "57fcc2e24446160c25e1fac48251c1da")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ResourceState)))
  "Returns md5sum for a message object of type 'ResourceState"
  "57fcc2e24446160c25e1fac48251c1da")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ResourceState>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'resource_geometry) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ResourceState>))
  ...
  (cl:list 'ResourceState
    ...
    (cl:cons ':resource_geometry (resource_geometry msg))
