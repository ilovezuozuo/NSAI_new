...
(cl:ensure-generic-function 'nolog-val :lambda-list '(m))
(cl:defmethod nolog-val ((m <Error>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:nolog-val is deprecated.  Use mir_msgs-msg:nolog instead.")
  (nolog m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Error>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'nolog) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Error>) istream)
  "Deserializes a message object of type '<Error>"
    ...
    (cl:setf (cl:slot-value msg 'nolog) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Error>)))
  ...
  "f8497742a4ea6b569fa00d679d96ce4f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Error)))
  "Returns md5sum for a message object of type 'Error"
  "f8497742a4ea6b569fa00d679d96ce4f")
