...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<HookExtendedStatus>)))
  ...
  "7a4c65a73248ad57ddff2231bb564f0d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'HookExtendedStatus)))
  "Returns md5sum for a message object of type 'HookExtendedStatus"
  "7a4c65a73248ad57ddff2231bb564f0d")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<HookExtendedStatus>)))
  ...
  (cl:format cl:nil "bool available~%~%BrakeState brake~%~%GripperState gripper~%~%HeightState height~%~%float32 angle~%~%string qr_marker_name~%~%================================================================================~%MSG: mir_msgs/BrakeState~%uint8 UNKNOWN = 0~%uint8 INITIALIZING = 1~%uint8 HOMING = 2~%uint8 ACTIVE = 3~%uint8 INACTIVE = 4~%uint8 ACTIVATING = 5~%uint8 DEACTIVATING = 6~%uint8 ERROR = 7~%~%uint8 state~%~%================================================================================~%MSG: mir_msgs/GripperState~%uint8 LOCK_UNKNOWN = 0~%uint8 LOCK_HOMING = 1~%uint8 LOCK_OPEN = 2~%uint8 LOCK_OPENING = 3~%uint8 LOCK_CLOSED = 4~%uint8 LOCK_CLOSING = 6~%uint8 LOCK_ERROR = 9~%~%uint8 state~%~%================================================================================~%MSG: mir_msgs/HeightState~%uint8 HEIGHT_UNKNOWN = 0~%uint8 HEIGHT_HOMING = 1~%uint8 HEIGHT_IDLE = 2~%uint8 HEIGHT_CHANGING = 3~%uint8 HEIGHT_ERROR = 4~%~%uint8 state~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'HookExtendedStatus)))
  "Returns full string definition for message of type 'HookExtendedStatus"
  (cl:format cl:nil "bool available~%~%BrakeState brake~%~%GripperState gripper~%~%HeightState height~%~%float32 angle~%~%string qr_marker_name~%~%================================================================================~%MSG: mir_msgs/BrakeState~%uint8 UNKNOWN = 0~%uint8 INITIALIZING = 1~%uint8 HOMING = 2~%uint8 ACTIVE = 3~%uint8 INACTIVE = 4~%uint8 ACTIVATING = 5~%uint8 DEACTIVATING = 6~%uint8 ERROR = 7~%~%uint8 state~%~%================================================================================~%MSG: mir_msgs/GripperState~%uint8 LOCK_UNKNOWN = 0~%uint8 LOCK_HOMING = 1~%uint8 LOCK_OPEN = 2~%uint8 LOCK_OPENING = 3~%uint8 LOCK_CLOSED = 4~%uint8 LOCK_CLOSING = 6~%uint8 LOCK_ERROR = 9~%~%uint8 state~%~%================================================================================~%MSG: mir_msgs/HeightState~%uint8 HEIGHT_UNKNOWN = 0~%uint8 HEIGHT_HOMING = 1~%uint8 HEIGHT_IDLE = 2~%uint8 HEIGHT_CHANGING = 3~%uint8 HEIGHT_ERROR = 4~%~%uint8 state~%~%~%"))
