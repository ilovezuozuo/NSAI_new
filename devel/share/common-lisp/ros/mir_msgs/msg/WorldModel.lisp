...
(cl:defclass <WorldModel> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (enable_resource_tracking
    :reader enable_resource_tracking
    :initarg :enable_resource_tracking
    :type cl:boolean
    :initform cl:nil))
)
...
(cl:ensure-generic-function 'enable_resource_tracking-val :lambda-list '(m))
(cl:defmethod enable_resource_tracking-val ((m <WorldModel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:enable_resource_tracking-val is deprecated.  Use mir_msgs-msg:enable_resource_tracking instead.")
  (enable_resource_tracking m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <WorldModel>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'enable_resource_tracking) 1 0)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WorldModel>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    (cl:setf (cl:slot-value msg 'enable_resource_tracking) (cl:not (cl:zerop (cl:read-byte istream))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<WorldModel>)))
  ...
  "580fee34fabf1d6f23f48ba7af5e653c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'WorldModel)))
  "Returns md5sum for a message object of type 'WorldModel"
  "580fee34fabf1d6f23f48ba7af5e653c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<WorldModel>)))
  ...
  (cl:format cl:nil "Header header~%mir_msgs/WorldMap[] world_map # world model for a particular map~%bool enable_resource_tracking~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: mir_msgs/WorldMap~%mir_msgs/ResourcesState positions~%mir_msgs/ResourcesState areas~%mir_msgs/ExternalRobots robots~%int32 map_id~%~%================================================================================~%MSG: mir_msgs/ResourcesState~%Header header~%ResourceState[] resources~%string token~%~%================================================================================~%MSG: mir_msgs/ResourceState~%string[] assigned # A list of IPs of all assigned robots (Areas can have more than one robot assigned at a time)~%uint32 ROBOT_POSITION=0~%uint32 STAGING_POSITION=1~%uint32 CHARGING_STATION=2~%uint32 AREA=3~%uint32 ELEVATOR_ENTRY_POSITION=26~%uint32 ELEVATOR_POSITION=25~%uint32 type # The resource type~%uint32 path_idx # The index from the global path in which the robot gets into the position~%float32 distance # The distance from the robot to the resource~%geometry_msgs/Point collision_point # The collision point with the resource~%geometry_msgs/Point[] resource_geometry # The resource_geometry~%string[] queue # The queue for a resource. It's a list of robots ips.~%string name # The name of the resource~%string guid # The guid of the resource~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: mir_msgs/ExternalRobots~%Header header~%mir_msgs/ExternalRobot[] robots~%~%================================================================================~%MSG: mir_msgs/ExternalRobot~%Header header~%uint32 id~%uint32 MIR100=1~%uint32 MIR500=3~%uint32 type_id~%string name~%float64 robot_length~%float64 robot_width~%string footprint~%string ip~%uint32 map_id~%int32 priority~%geometry_msgs/Pose pose~%geometry_msgs/Pose extrapolated_pose~%geometry_msgs/Twist twist~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'WorldModel)))
  "Returns full string definition for message of type 'WorldModel"
  (cl:format cl:nil "Header header~%mir_msgs/WorldMap[] world_map # world model for a particular map~%bool enable_resource_tracking~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: mir_msgs/WorldMap~%mir_msgs/ResourcesState positions~%mir_msgs/ResourcesState areas~%mir_msgs/ExternalRobots robots~%int32 map_id~%~%================================================================================~%MSG: mir_msgs/ResourcesState~%Header header~%ResourceState[] resources~%string token~%~%================================================================================~%MSG: mir_msgs/ResourceState~%string[] assigned # A list of IPs of all assigned robots (Areas can have more than one robot assigned at a time)~%uint32 ROBOT_POSITION=0~%uint32 STAGING_POSITION=1~%uint32 CHARGING_STATION=2~%uint32 AREA=3~%uint32 ELEVATOR_ENTRY_POSITION=26~%uint32 ELEVATOR_POSITION=25~%uint32 type # The resource type~%uint32 path_idx # The index from the global path in which the robot gets into the position~%float32 distance # The distance from the robot to the resource~%geometry_msgs/Point collision_point # The collision point with the resource~%geometry_msgs/Point[] resource_geometry # The resource_geometry~%string[] queue # The queue for a resource. It's a list of robots ips.~%string name # The name of the resource~%string guid # The guid of the resource~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: mir_msgs/ExternalRobots~%Header header~%mir_msgs/ExternalRobot[] robots~%~%================================================================================~%MSG: mir_msgs/ExternalRobot~%Header header~%uint32 id~%uint32 MIR100=1~%uint32 MIR500=3~%uint32 type_id~%string name~%float64 robot_length~%float64 robot_width~%string footprint~%string ip~%uint32 map_id~%int32 priority~%geometry_msgs/Pose pose~%geometry_msgs/Pose extrapolated_pose~%geometry_msgs/Twist twist~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%================================================================================~%MSG: geometry_msgs/Twist~%# This expresses velocity in free space broken into its linear and angular parts.~%Vector3  linear~%Vector3  angular~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%~%"))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <WorldModel>))
  ...
  (cl:list 'WorldModel
    ...
    (cl:cons ':enable_resource_tracking (enable_resource_tracking msg))
))
