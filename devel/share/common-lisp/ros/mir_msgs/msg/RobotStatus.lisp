...
(cl:defclass <RobotStatus> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (hook_data
    :reader hook_data
    :initarg :hook_data
    :type mir_msgs-msg:HookData
    :initform (cl:make-instance 'mir_msgs-msg:HookData))
   (map_id
    :reader map_id
    :initarg :map_id
    :type cl:string
   ...
   (safety_system_muted
    :reader safety_system_muted
    :initarg :safety_system_muted
    :type cl:boolean
    :initform cl:nil)
   (joystick_low_speed_mode_enabled
    :reader joystick_low_speed_mode_enabled
    :initarg :joystick_low_speed_mode_enabled
    :type cl:boolean
    :initform cl:nil)
   (joystick_web_session_id
    :reader joystick_web_session_id
    :initarg :joystick_web_session_id
    :type cl:string
    :initform "")
   (mode_key_state
    :reader mode_key_state
    :initarg :mode_key_state
    :type cl:string
    :initform ""))
)
...
(cl:ensure-generic-function 'hook_data-val :lambda-list '(m))
(cl:defmethod hook_data-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:hook_data-val is deprecated.  Use mir_msgs-msg:hook_data instead.")
  (hook_data m))
...
(cl:ensure-generic-function 'safety_system_muted-val :lambda-list '(m))
(cl:defmethod safety_system_muted-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:safety_system_muted-val is deprecated.  Use mir_msgs-msg:safety_system_muted instead.")
  (safety_system_muted m))

(cl:ensure-generic-function 'joystick_low_speed_mode_enabled-val :lambda-list '(m))
(cl:defmethod joystick_low_speed_mode_enabled-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:joystick_low_speed_mode_enabled-val is deprecated.  Use mir_msgs-msg:joystick_low_speed_mode_enabled instead.")
  (joystick_low_speed_mode_enabled m))

(cl:ensure-generic-function 'joystick_web_session_id-val :lambda-list '(m))
(cl:defmethod joystick_web_session_id-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:joystick_web_session_id-val is deprecated.  Use mir_msgs-msg:joystick_web_session_id instead.")
  (joystick_web_session_id m))

(cl:ensure-generic-function 'mode_key_state-val :lambda-list '(m))
(cl:defmethod mode_key_state-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mir_msgs-msg:mode_key_state-val is deprecated.  Use mir_msgs-msg:mode_key_state instead.")
  (mode_key_state m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <RobotStatus>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'hook_data) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'safety_system_muted) 1 0)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'joystick_low_speed_mode_enabled) 1 0)) ostream)
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'joystick_web_session_id))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'joystick_web_session_id))
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'mode_key_state))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'mode_key_state))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <RobotStatus>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'hook_data) istream)
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'user_prompt) istream)
    (cl:setf (cl:slot-value msg 'safety_system_muted) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:setf (cl:slot-value msg 'joystick_low_speed_mode_enabled) (cl:not (cl:zerop (cl:read-byte istream))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'joystick_web_session_id) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'joystick_web_session_id) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'mode_key_state) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'mode_key_state) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<RobotStatus>)))
  ...
  "7b840ddb96dfd7ada160f7cf87874a66")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'RobotStatus)))
  "Returns md5sum for a message object of type 'RobotStatus"
  "7b840ddb96dfd7ada160f7cf87874a66")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <RobotStatus>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'hook_data))
     ...
     1
     1
     4 (cl:length (cl:slot-value msg 'joystick_web_session_id))
     4 (cl:length (cl:slot-value msg 'mode_key_state))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <RobotStatus>))
  ...
  (cl:list 'RobotStatus
    ...
    (cl:cons ':hook_data (hook_data msg))
    ...
    (cl:cons ':safety_system_muted (safety_system_muted msg))
    (cl:cons ':joystick_low_speed_mode_enabled (joystick_low_speed_mode_enabled msg))
    (cl:cons ':joystick_web_session_id (joystick_web_session_id msg))
    (cl:cons ':mode_key_state (mode_key_state msg))
))
