...
bool operator==(const ::easy_handeye_msgs::RemoveSampleResponse_<ContainerAllocator1> & lhs, const ::easy_handeye_msgs::RemoveSampleResponse_<ContainerAllocator2> & rhs)
{
