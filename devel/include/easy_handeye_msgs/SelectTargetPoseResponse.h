...
bool operator==(const ::easy_handeye_msgs::SelectTargetPoseResponse_<ContainerAllocator1> & lhs, const ::easy_handeye_msgs::SelectTargetPoseResponse_<ContainerAllocator2> & rhs)
{
