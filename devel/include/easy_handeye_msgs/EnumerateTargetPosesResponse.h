...
bool operator==(const ::easy_handeye_msgs::EnumerateTargetPosesResponse_<ContainerAllocator1> & lhs, const ::easy_handeye_msgs::EnumerateTargetPosesResponse_<ContainerAllocator2> & rhs)
{
  return lhs.target_poses == rhs.target_poses;
}
