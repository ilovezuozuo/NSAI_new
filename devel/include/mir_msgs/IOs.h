...
#if defined(_WIN32) && defined(DONE)
  #undef DONE
#endif
...
bool operator==(const ::mir_msgs::IOs_<ContainerAllocator1> & lhs, const ::mir_msgs::IOs_<ContainerAllocator2> & rhs)
{
  return lhs.module_guid == rhs.module_guid &&
