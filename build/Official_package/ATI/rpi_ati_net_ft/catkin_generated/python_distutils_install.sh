...
echo_and_run cd "/home/inexbot/NSAI_new/src/Official_package/ATI/rpi_ati_net_ft"
...
echo_and_run /usr/bin/env \
    ...
    "/home/inexbot/NSAI_new/src/Official_package/ATI/rpi_ati_net_ft/setup.py" \
     \
    build --build-base "/home/inexbot/NSAI_new/build/Official_package/ATI/rpi_ati_net_ft" \
    install \
    --root="${DESTDIR-/}" \
