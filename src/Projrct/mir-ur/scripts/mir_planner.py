...
# import numpy as np
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_aim_target import TrueAimTarget
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_move import TrueMove
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_clear_obstacle import TrueClearObstacle
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_recognition import TrueRecognition
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_ur_change import TrueChange
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_insert import TrueInsert
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_disassemble import TrueDisassemble
from fmauch_universal_robot.ur_real_robot.ur_control.scripts.mir_ur.mir_action import PrimAction
...
if __name__ == '__main__':
    ...
    try:
        ...
        # pose_target.position.x = 0.028
        # pose_target.position.y = 0.605
        # pose_target.position.z = 0.60

        # pose_target.position.x = -0.008
        # pose_target.position.y = 0.381
        # pose_target.position.z = 0.6
        pose_target.position.x = 0.133
        pose_target.position.y = 0.641
        pose_target.position.z = 0.6
        ...
        planner.sleeve_type="hex_bolt_10"
